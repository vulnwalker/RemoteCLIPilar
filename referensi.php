...
class SetupClass extends Config{
  ...
  function __construct(){
    ...
    if(empty($dirName))$dirName = "referensi";
    switch ($type) {
      case 'dump':
  ...
  function dumpTable($tableName) {
    ...
    $dumpString = shell_exec("mysqldump -u".$this->userMysql." -p".$this->passwordMysql." --skip-events --skip-routines --skip-triggers --skip-add-drop-table $this->databaseName $tableName");
