...
--
-- Table structure for table `pemusnahan_persediaan`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pemusnahan_persediaan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tahun` int(11) NOT NULL,
  `nomor_pemusnahan` text COLLATE latin1_general_ci NOT NULL,
  `id_cek_fisik` text COLLATE latin1_general_ci NOT NULL,
