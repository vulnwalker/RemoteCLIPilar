...
--
-- Table structure for table `dkpb`
--
...
CREATE TABLE `dkpb` (
  ...
  `idrkpb` int(11) DEFAULT NULL,
  `kapitalisasi` tinyint(3) DEFAULT '1' COMMENT '1=tidak, 2=ya',
  ...
  `thn_anggaran` char(4) COLLATE latin1_general_ci NOT NULL,
