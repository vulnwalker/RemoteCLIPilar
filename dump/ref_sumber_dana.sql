...
CREATE TABLE `ref_sumber_dana` (
  `nama` varchar(100) CHARACTER SET latin1 NOT NULL DEFAULT '',
  PRIMARY KEY (`nama`)
...
INSERT INTO `ref_sumber_dana` VALUES ('APBD'),('BANPROV'),('Block Grand'),('BLUD'),('BOS APBD'),('BOS APBN'),('DAK'),('Hibah Provinsi'),('Hibah Pusat'),('JKN'),('Komite'),('Taufan Sumber Dana'),('Wakaf');
