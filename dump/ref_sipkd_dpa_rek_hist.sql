...
--
-- Table structure for table `ref_sipkd_dpa_rek_hist`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ref_sipkd_dpa_rek_hist` (
  ...
  `uid_hist` varchar(25) COLLATE latin1_general_ci DEFAULT NULL COMMENT 'uidlog',
  PRIMARY KEY (`id`),
  KEY `c1` (`c1`,`c`,`d`,`bk`,`ck`,`dk`,`p`,`q`,`k`,`l`,`m`,`n`,`o`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci ROW_FORMAT=COMPACT COMMENT='dpa skpd, kegiatan, kode rek dari integrasi sipkd';
