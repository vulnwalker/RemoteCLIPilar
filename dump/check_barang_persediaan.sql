...
--
-- Table structure for table `check_barang_persediaan`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `check_barang_persediaan` (
  ...
  `type` text NOT NULL,
  `id_t_kartu_persediaan` text NOT NULL,
  `tahun` text NOT NULL,
  `periode` text NOT NULL,
  `status` text NOT NULL,
  `id_transaksi` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21149 DEFAULT CHARSET=latin1;
