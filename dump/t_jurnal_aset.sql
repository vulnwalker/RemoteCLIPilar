...
--
-- Table structure for table `t_jurnal_aset`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_jurnal_aset` (
  ...
  `f` varchar(2) COLLATE latin1_general_ci NOT NULL DEFAULT '00',
  `g` varchar(2) COLLATE latin1_general_ci NOT NULL DEFAULT '00' COMMENT '00',
  `h` varchar(2) COLLATE latin1_general_ci NOT NULL DEFAULT '00',
  `i` varchar(2) COLLATE latin1_general_ci NOT NULL DEFAULT '00',
  `j` varchar(3) COLLATE latin1_general_ci NOT NULL DEFAULT '000',
  `jns_trans` int(11) DEFAULT '0',
  `jns_trans2` int(11) DEFAULT '0',
  `jns_trans3` int(11) DEFAULT '0',
  `refid` int(11) DEFAULT NULL,
  `refid2` int(11) DEFAULT NULL,
  `idbi` int(11) DEFAULT NULL,
  `idawal` int(11) DEFAULT NULL,
  `jml_barang_d` int(11) DEFAULT '0' COMMENT '0',
  `jml_barang_k` int(11) DEFAULT '0' COMMENT '0',
  ...
  `stposting` tinyint(3) DEFAULT '0' COMMENT 'status posting 0 = belum,1 = sudah, 2=proses posting',
  `refid_trans` int(11) DEFAULT NULL COMMENT 't_transaksi.id',
  PRIMARY KEY (`Id`),
  KEY `refid` (`refid`),
  KEY `idbi` (`idbi`),
  KEY `idawal` (`idawal`),
  ...
  KEY `jns_trans3` (`jns_trans3`),
  KEY `refid_trans` (`refid_trans`)
) ENGINE=InnoDB AUTO_INCREMENT=8587428 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
