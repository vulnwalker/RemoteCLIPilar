...
--
-- Table structure for table `t_kas_bendahara_penerimaan`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_kas_bendahara_penerimaan` (
  ...
  `cara_setor` tinyint(1) unsigned DEFAULT NULL COMMENT '1=Transfer, 2=Kas',
  `refid` int(11) unsigned DEFAULT NULL,
  `refid_dari` tinyint(1) DEFAULT NULL,
