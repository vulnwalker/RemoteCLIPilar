...
--
-- Table structure for table `temp_rincian_saldo_awal_persediaan`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `temp_rincian_saldo_awal_persediaan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_saldo_awal` int(11) NOT NULL,
  `username` text COLLATE latin1_general_ci NOT NULL,
  `kode_barang` text COLLATE latin1_general_ci NOT NULL,
