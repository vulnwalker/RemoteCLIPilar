...
CREATE TABLE `inventaris` (
  ...
  `alasan` int(11) DEFAULT NULL COMMENT '1. Mutasi SKPD, 2. Hibah, 3. hilang, 4. Lainnya',
...
) ENGINE=InnoDB AUTO_INCREMENT=256 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci ROW_FORMAT=COMPACT;
