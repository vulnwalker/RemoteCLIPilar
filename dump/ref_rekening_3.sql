...
--
-- Table structure for table `ref_rekening_3`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ref_rekening_3` (
  ...
  `nm_rekening` varchar(256) COLLATE latin1_general_ci NOT NULL,
  ...
  `debet_k` char(1) COLLATE latin1_general_ci NOT NULL COMMENT 'kolorari debet',
  ...
  `debet_o` char(3) COLLATE latin1_general_ci NOT NULL,
  `kredit_k` char(1) COLLATE latin1_general_ci NOT NULL COMMENT 'kolorari kredit',
  ...
  `kredit_o` char(3) COLLATE latin1_general_ci NOT NULL,
