...
CREATE TABLE `t_penerimaan_barang` (
  ...
  `status_dpa_sipkd` tinyint(3) NOT NULL DEFAULT '0' COMMENT '1= integrasi sipkddpa',
  `status_dpa` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1=aktif, 0=tidak',
  PRIMARY KEY (`Id`),
  KEY `c1` (`c1`,`c`,`d`,`e`,`e1`),
  KEY `bk` (`bk`,`ck`,`dk`,`p`,`q`),
  KEY `jns_trans` (`jns_trans`)
) ENGINE=InnoDB AUTO_INCREMENT=4990 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci ROW_FORMAT=COMPACT;
