...
--
-- Table structure for table `t_penerimaan_retensi_rekening`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_penerimaan_retensi_rekening` (
  ...
  PRIMARY KEY (`Id`),
  KEY `k` (`k`,`l`,`m`,`n`,`o`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci ROW_FORMAT=COMPACT;
