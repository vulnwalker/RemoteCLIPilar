...
--
-- Table structure for table `casir_login`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `casir_login` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `casir_name` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `status` int(3) NOT NULL COMMENT '1 : is being used, 2 : not in use',
